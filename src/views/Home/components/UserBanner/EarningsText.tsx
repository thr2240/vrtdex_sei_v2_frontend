...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and VRT pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and VRT pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from VRT pool', data)
  }
