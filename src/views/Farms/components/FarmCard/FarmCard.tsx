...
const FarmCard: React.FC<React.PropsWithChildren<FarmCardProps>> = ({
  ...
  const lpLabel = farm.lpSymbol && farm.lpSymbol.toUpperCase().replace('VRT', '')
  const earnLabel = farm.dual ? farm.dual.earnLabel : t('VRT + Fees')
  ...
  const isPromotedFarm = farm.token.symbol === 'VRT'
