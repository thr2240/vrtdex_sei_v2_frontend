...
const StartPage: React.FC<React.PropsWithChildren<StartPageProps>> = ({
  ...
  /**
   * Check if the wallet has the required VRT allowance to change their profile pic or reactivate
      ...
      <Flex alignItems="center" style={{ height: '48px' }} justifyContent="center">
        <Text as="p" color="failure">
          {!isProfileCostsLoading &&
            ...
            t('%minimum% VRT required to change profile pic', { minimum: formatBigNumber(minimumCakeRequired) })}
        </Text>
      </Flex>
      {profile.isActive ? (
        <>
