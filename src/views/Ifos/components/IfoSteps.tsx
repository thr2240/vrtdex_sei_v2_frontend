    ...
    <CardBody>
      ...
      <Box>
        <Text mb="4px" color="textSubtle" small>
          {t(
            'The maximum amount of VRT you can commit to the Public Sale equals the number of your iVRTDEX. Lock more VRT for longer durations to increase the maximum VRT you can commit to the sale.',
          )}
        </Text>
        <TooltipText as="span" fontWeight={700} ref={targetRef} color="textSubtle" small>
          {t('How does the number of iVRTDEX calculated?')}
        </TooltipText>
        <Text mt="4px" color="textSubtle" small>
          {t(
            'Missed this IFO? You will enjoy the same amount of iVRTDEX for future IFOs if your locked-staking position is not unlocked.',
          )}
        </Text>
      </Box>
      {hasProfile && (
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active Vrtdex Profile to take part in an IFO!')}
            </Text>
            {renderAccountStatus()}
          </CardBody>
        )
